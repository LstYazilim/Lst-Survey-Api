...
public partial class Product
{
    ...
    public virtual ICollection<ProductAttributeCombination> ProductAttributeCombinations { get; } = new List<ProductAttributeCombination>();

    public virtual ICollection<ProductCategoryMapping> ProductCategoryMappings { get; } = new List<ProductCategoryMapping>();

    public virtual ICollection<ProductManufacturerMapping> ProductManufacturerMappings { get; } = new List<ProductManufacturerMapping>();

    public virtual ICollection<ProductPictureMapping> ProductPictureMappings { get; } = new List<ProductPictureMapping>();
    ...
    public virtual ICollection<StockQuantityHistory> StockQuantityHistories { get; } = new List<StockQuantityHistory>();
